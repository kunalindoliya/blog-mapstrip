                        ...
                        function selectbox() {
                            ...
                            function makeList() {
                                for (i = 0, len = option.length; i < len; i++) {
                                    var li = '', liClass = '', optionClass = '', optgroupClass = '';
                            ...
                            function doSelect() {
                                var selectbox = $('<span' + id + ' class="jq-selectbox jqselect' + cl + '" style="display: inline-block; position: relative; z-index:' + opt.singleSelectzIndex + '">' +
                                ...
                                if (el.is(':disabled')) {
                                    ...
                                    makeList();
                                    var dropdown = $('<div class="jq-selectbox__dropdown" style="position: absolute; overflow: auto; overflow-x: hidden">' +
